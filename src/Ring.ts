...
export class Ring {
  ...
  public edges: number[];
  public insiders: number[];
  public neighbours: number[];
  public positioned: boolean;
  public center: Vector2;
  public rings: Ring[];
  public isBridged: boolean;
  public isPartOfBridged: boolean;
  public isSpiro: boolean;
  ...
  ): Array<{ n: number; neighbour: number }> {
